...
HAB_VECINOS_OFFSET     EQU 0        ; uint32_t vecinos[ACC_CANT] (4 entradas)
HAB_CONTENIDO_OFFSET   EQU 0        ; Contenido contenido (aligned to 4)
...
MAP_N_HABITACIONES_OFFSET  EQU 0     ; uint64_t n_habitaciones       (8 bytes)
MAP_ID_ENTRADA_OFFSET      EQU 0    ; uint32_t id_entrada         (4 bytes)
MAP_SIZE                   EQU 0    ; sizeof(Mapa) (padded to 8)

; ------------------------
; Recorrido
; ------------------------
REC_ACCIONES_OFFSET        EQU 0     ; Accion *acciones  (pointer, 8 bytes)
REC_CANT_ACCIONES_OFFSET   EQU 0     ; uint64_t cant_acciones (8 bytes)
